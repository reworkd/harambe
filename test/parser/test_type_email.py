...
@pytest.mark.parametrize(
    "email, expected",
    [
        ("mailto:segreteria.capogabinetto@ministeroturismo.gov.it", "segreteria.capogabinetto@ministeroturismo.gov.it"),
...
@pytest.mark.parametrize("invalid_email", ["invalid", "invalid@", "invalid@.", "invalid@.com", "invalid@com.", 123, None])
